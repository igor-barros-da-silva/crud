...
public class App {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        declaracao.execute("CREATE TABLE if not exists PESSOA(ID INT NOT NULL IDENTITY, NOME VARCHAR(255) NOT NULL UNIQUE, IDADE CHAR(3) NOT NULL UNIQUE, RG VARCHAR(255) NOT NULL, CPF VARCHAR(255) NOT NULL UNIQUE, IDCIDADE INTEGER NOT NULL);");
